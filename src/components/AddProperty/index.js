...
const AddPropertyPage = () => ( // for the use of routing
  <div>
...
class AddPropertyDisplayBase extends Component {
  constructor(props) {
    super(props);
  ...
  selectDataType(key){
    ...
    if(dataType.propertyDataType==='Numeric'){
        this.props.history.push({
            pathname: '/create-numeric-property',
            state: { dataType: dataType }
        })
    }
    else if(dataType.propertyDataType==='Option'){
        this.props.history.push({
            pathname: '/create-option-property',
            state: { dataType: dataType }
        })
    }
    else if(dataType.propertyDataType==='Text'){
      this.props.history.push({
          pathname: '/create-text-property',
...
const AddPropertyDisplay = withRouter(withFirebase(AddPropertyDisplayBase));
const authCondition = authUser => !!authUser;
export default withAuthorization(authCondition)(AddPropertyPage);

export { AddPropertyDisplay };
